...
const faqs = [
  {
    ...
    answer:
      "Нет, платформа разработана для владельцев бизнеса без технических навыков. AI-консультант настраивается автоматически, а все инструменты имеют понятный интерфейс с подсказками.",
  },
  {
