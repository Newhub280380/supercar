  ...
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-0 left-1/4 size-[500px] rounded-full bg-teal-500/8 blur-3xl animate-pulse" />
        <div className="absolute top-20 right-1/4 size-[400px] rounded-full bg-cyan-500/10 blur-3xl animate-pulse [animation-delay:1s]" />
      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
        <div className="flex flex-col items-center text-center">
          <div className="mb-6 flex items-center gap-2 rounded-full border border-teal-200 bg-teal-50 px-4 py-1.5 text-xs font-medium text-teal-700 dark:border-teal-900 dark:bg-teal-950/50 dark:text-teal-300">
          ...
          <h1 className="max-w-4xl font-heading text-4xl font-bold leading-tight tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
            <span className="text-teal-600 dark:text-teal-400">Mom AI Assistant</span>
            <br />
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row">
            <Link href="#cta" className={cn(buttonVariants({ size: "lg" }), "gap-2 bg-teal-600 hover:bg-teal-700 text-white")}>
              Kostenlos starten
          ...
          <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-3 sm:gap-8 text-center text-sm text-muted-foreground">
            ...
            <div className="flex items-center justify-center gap-2">
              <Heart className="size-4 text-teal-500" />
