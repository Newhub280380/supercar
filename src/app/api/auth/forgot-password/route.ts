...
const GENERIC_RESPONSE = { message: "If the email exists, a reset link has been sent" };

export const POST = withErrorHandling("Forgot password error", async (request: NextRequest) => {
