        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-muted-foreground text-xs">
              Измените фильтры или добавьте новую услугу
            </p>
          </CardContent>
        </Card>
      )}
          ...
          <div className="space-y-3 py-2">
            ...
            <Field label="Описание">
              <textarea
                ...
                className="border-border focus-visible:ring-ring/50 w-full resize-none rounded-lg border bg-transparent px-2.5 py-2 text-sm outline-none focus-visible:ring-2"
              />
            </Field>
            ...
            <Field label="Категория">
              <select
                ...
                className="border-border bg-background focus-visible:ring-ring/50 h-8 w-full rounded-lg border px-2.5 text-sm outline-none focus-visible:ring-2"
              >
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Услуга «{deleteTarget?.name}» будет удалена. Это действие нельзя
              отменить.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
